...
##### *1. Affordability Calculation* {.unnumbered}
...
##### *2. T-test Affordability* {.unnumbered}
...
```{r h2_t-test, warning = FALSE, class.source="fold-hide", results='hide'}
t.test(
...
```{r Figure 6, echo=FALSE, fig.align="center", out.width="70%", message=FALSE, warning=FALSE}
...
```{r Figure 7, echo=FALSE, fig.align="center", out.width="70%", message=FALSE, warning=FALSE}
...
Decide on which boxplot version (fig 6 or fig 8)
...
##### *2. Boxplot of affordability by building age group* {.unnumbered}
