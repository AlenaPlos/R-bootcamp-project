...
Income levels and population density are included as **contextual variables** that capture differences in purchasing power and urban structure across Warsaw’s districts. As both variables are observed only at aggregated spatial levels, their descriptive analysis focuses on central tendencies and relative differences between districts rather than detailed distributional characteristics. These summaries provide background context for the subsequent hypothesis-driven analysis, where the relationship between density, income, and residential prices is examined in more detail.

```{r wage_density_analysis, echo = FALSE}
...
<br>
<br>
![Housing affordability by building age group](Rplot_Building_Age_h3.png){width=90%}
<br>
<br>
